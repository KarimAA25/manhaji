    ...
    <main id="main-content" tabIndex={-1} className="p-shell">
      <article className="p-article">
        ...
        <div className="p-ip-banner">
          <b style={{ color: "#7B341E" }}>Manhaji IP:</b> the 6-axis rubric framework, the radar visualisation,
          the report card template and the university-fit bands below are Manhaji-built — schools don&apos;t define these.
        </div>
        ...
        <div className="p-body">
          ...
          <Section label="This month at a glance">
            <div style={{
              ...
              <div style={{ fontSize: 11, color: "var(--muted)", marginTop: 10, fontStyle: "italic" }}>
                Drafted by Manhaji &middot; reviewed and approved by Ms Sandra Swart &middot; 8 May 2026
              </div>
            </div>
          </Section>
          ...
          {/* Rubric radar */}
          <Section label="Manhaji rubric · 6-axis competency profile" title="Strengths & areas to build · this month">
            ...
            <div style={{ marginTop: 14, fontSize: 11, color: "var(--muted)", fontStyle: "italic" }}>
              Manhaji scores every subject against the same 6 universal axes so parents can compare strengths
          ...
          <Section label="Improvement plan · this month" title={`Three concrete actions for ${student.split(" ")[0]}`}>
            <div className="p-grid-3">
              {[
                { n: "1", h: "Written Arabic structure", p: `Three 15-minute essay-outline exercises per week using the Manhaji scaffolds. Sample prompts attached — ${student.split(" ")[0]} can pick from any.` },
          ...
          <Section label="University placement signal · early indicator" title={`Where students with profiles like ${student.split(" ")[0]}'s have landed`}>
            <div style={{
              ...
              <div style={{ fontSize: 10, color: "var(--muted)", fontStyle: "italic", marginBottom: 10 }}>
                Based on Manhaji rubric profile + IGCSE projection compared against International School of
        ...
        <div className="p-footer">
          <span>Generated by Manhaji · reviewed and approved by {student.split(" ")[0]}&apos;s teachers · 8 May 2026</span>
...
function RubricRadarSvg({ axes }: { axes: Axis[] }) {
  ...
  return (
    ...
    >
      <title id="radar-title">Manhaji 6-axis competency profile</title>
      <desc id="radar-desc">
